    ...
    <form action="{{ route('departments.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="nama_departemen" required placeholder="Contoh: Information Technology"
                   ...
                   class="w-full px-3 py-2 border {{ $errors->has('nama_departemen') ? 'border-red-500' : 'border-gray-300' }} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
